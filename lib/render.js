...
exports.createContext = function(webshopUid, webshopUrl, apiUrl, swsUrl, diversityUrl, spec, auth, prerender) {
  return {
    scripts: [],
    styles: [],
    modules: [],
    ...
    context: {
      ...
      'apiUrl': apiUrl.replace(/^https?:\/\//, ''), // No protocol to frontend.
